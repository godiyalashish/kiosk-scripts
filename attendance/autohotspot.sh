...
createAdHocNetwork()
{
    ...
    python3 /home/admin/attendance/display_message.py 'Turning hotspot on'
    ...
    python /home/admin/attendance/display_message.py  "Hotspot open please" "visit ip address and" "enter wifi cred."
    sleep 4
    python /home/admin/attendance/display_message.py "ssid: RPiHotspot" "psd: 1234567890" "connect and visit" "http://10.0.0.5"
    python /home/admin/attendance/server/server.py
}

KillHotspot()
{
python /home/admin/attendance/display_message.py "Turning hotspot off" 
    echo "Autohotspot by RaspberryConnect.com"
...
ChkWifiUp()
{
	...
	python /home/admin/attendance/display_message.py "Connecting to wifi"
        sleep 20 #give time for connection to be completed to router
	if ! wpa_cli -i "$wifidev" status | grep 'ip_address' >/dev/null 2>&1
        then #Failed to connect to wifi (check your wifi settings, password etc)
	       echo 'Wifi failed to connect, falling back to Hotspot.'
               python /home/admin/attendance/display_message.py "failed to connect to wifi"
               wpa_cli terminate "$wifidev" >/dev/null 2>&1
	       createAdHocNetwork
	else
		python /home/admin/attendance/display_message.py "Connected to wifi" "successfully"
		sleep 1
		/home/admin/attendance/Attendance-backend/start-server
		python /home/admin/attendance/faceRecognition/test_server_health.py
		python /home/admin/attendance/faceRecognition/sync_data.py
		#python /home/admin/attendance/faceRecognition/main.py
...
python3 /home/admin/attendance/display_message.py 'Welcome'
...
then
       ...
       then #Already connected
	      ...
	      python /home/admin/attendance/display_message.py "Wifi connected"
